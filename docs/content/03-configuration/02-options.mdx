...
description: "Complete reference for Kiira config options: include, exclude, tsconfig, packageMode, defaultValidate, defaultGroup, checkUnusedSymbols, checkRelativeImports, overrides, externalPackages, fixtures, defaultFixture, and languages."
---
