...
Besides compiler options, an override can carry [`defaultGroup`](/latest/configuration/options) to opt a subtree in or out of file-level grouping. The last matching override wins, so you can file-group your guides while keeping a reference section isolated:
...
See [Grouping snippets](/latest/fences/grouping-snippets) for what file-level grouping does.
