...
Running [`kiira check --fix`](/cli/fix) then **writes that override into your config** for you, so subsequent runs compile those files against the right framework automatically.
